...
$images = selectByQuery("SELECT * FROM reference WHERE reference = 'BATIMENT' ");
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
  ...
  $article = selectByQuery("SELECT * FROM reference WHERE reference = 'BATIMENT'  AND id=".$_GET['id']);
}else{
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            ...
            <ul>
              <li><strong>Catégorie</strong>: Bâtiment</li>
              <li><strong>Client</strong>: <?= htmlentities($article[0]['client_name']) ?></li>
            </ul>
          </div>
