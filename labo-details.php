...
<head>
  ...
  <title>Sondages et essais IN-situ</title>
  ...
  <meta content="btp plus services, btp, btp geotech, laboratoire" name="keywords">
...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.php">BTP<sup>+</sup>Services</a></h1>
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><a href="labo-details.php" target="_blank" style="color: black;">Ingénierie Géotechnique</a></li>
                  <li></i><a href="labo/sondages_insitu.php" style="color: black;"> Sondages et essais in situ</a></li>
                  <li><a href="#" style="color: black;">Laboratoire</a></li>
          </ol>
        </div>
      ...
      <div class="">
        <div class="row">
          ...
          <div class="offset-md-1  col-md-5">
             <img src="assets/img/pngwing.com(14).png" class="img-fluid" alt="">
          </div>

          <div class="portfolio-description col-md-6">
            <h2></h2>
            <p>
              <strong>BTP<sup>+</sup> participe à toutes les phases de l'élaboration et de la réalisations des ouvrages géotechniques:</strong><li style="list-style-type: none;">Etudes géotechiques préalables</li><li style="list-style-type: none;">Etudes géotechniques de conception</li><li style="list-style-type: none;">Etudes géotechnique de réalisation.</li> </p> <br>

              <p><strong>Nos domaines d'intervations:</strong></p>
              <p><li><strong><span style="color: #5F7CC2;">BATIMENTS:</span></strong> Industrie, commerces, entrepôts, bureaux, logements. </li>

                <li><strong><span style="color: #5F7CC2;">ENERGIE:</span></strong> Production(Centrale hydroélectrique, éoliennes(terrestre), parcs photovoltaique, transport de lignes électriques)</li>

                <li><strong><span style="color: #5F7CC2;">GENIE CIVIL:</span></strong>Ouvrages aériens et enterrés</li>

                <li><strong><span style="color: #5F7CC2;">TRACE LINEAIRE:</span></strong> Ouvrages d'art, tunnels, gazoducs</li>

                <li><strong><span style="color: #5F7CC2;"> OUVRAGES FLUVIAUX ET PORTUAIRES:</span></strong>Ports, digues, émissaires</li>
              </p>
              <p> </p>
