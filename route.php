...
$images = selectByQuery("SELECT * FROM reference WHERE reference = 'ROUTE' ");
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
  ...
  $article = selectByQuery("SELECT * FROM reference WHERE reference = 'ROUTE'  AND id=".$_GET['id']);
}else{
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Routes-Détails</h2>
          <ol>
            <li><a href="index.php">Acceuil</a></li>
            <li>Références>Routes</li>
          </ol>
        </div>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            ...
            <ul>
              <li><strong>Catégorie</strong>: Routes</li>
              <li><strong>Client</strong>: <?= nl2br($article[0]['client_name']) ?? ""  ?></li>
